...
var url = "http://vip.stock.finance.sina.com.cn/q/view/vFutures_History.php?page=1&breed=XPT&start=1988-08-04&end=2017-06-Su&jys=LIFFE&pz=XPT&hy=&type=global&name=";
new CheerioUtil_1.CheerioUtil().parseUrl(url, {}, function ($, params, body) {
    var pagePs = [];
